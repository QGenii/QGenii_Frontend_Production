...
const InterviewQuestionCard = ({ card }) => {
  const navigate = useNavigate();

  const handleCardClick = () => {
    navigate(`/interview-questions/${card.id}`);
  };

  return (
    <div className="col">
      <div className="card interview-card shadow-sm h-100 border-0" onClick={handleCardClick}>
