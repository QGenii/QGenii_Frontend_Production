...
const DifficultyRatingCard = ({ card }) => {
  const navigate = useNavigate();

  const handleCardClick = () => {
    navigate(`/difficulty-rating/${card.id}`);
  };

  return (
    <div className="col">
      <div className="card difficulty-card shadow-sm h-100 border-0" onClick={handleCardClick}>
...
export default DifficultyRatingCard;