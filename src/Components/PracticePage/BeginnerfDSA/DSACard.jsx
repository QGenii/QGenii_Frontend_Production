...
const DSACard = ({ card }) => {
  ...
  const handleCardClick = () => {
    navigate(`/dsa/${card.id}`);
  };

  return (
    <div className="col">
      <div className="card dsa-card shadow-sm h-100 border-0" onClick={handleCardClick}>
        <div className={`card-header ${card.color} py-3 border-0 rounded-top`}>
