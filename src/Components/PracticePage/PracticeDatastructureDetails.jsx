...
const practiceData = {
  c: {
    title: "Practice Company wise questions",
    description: "Sharpen your DSA skills with curated problems and chapter-wise practice.",
    progress: 65,
    streak: 3,
    leaderboard: 5,
    chapters: [
...
const PracticeDataStructureDetails = () => {
  const { id } = useParams();
...
export default PracticeDataStructureDetails;