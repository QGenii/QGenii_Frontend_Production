...
const LanguagePracticeCard = ({ card }) => {
  return (
    <div className="col">
      <div className="card language-practice-card shadow-sm h-100 border-0">
        <div className={`card-header bg-language-pink py-3 text-white border-0 rounded-top`}>
...
export default LanguagePracticeCard;