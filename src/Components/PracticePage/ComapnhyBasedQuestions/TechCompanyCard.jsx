...
const TechCompanyCard = ({ card }) => {
  const navigate = useNavigate();

  const handleCardClick = () => {
    navigate(`/company-specific-questions/${card.id}`);
  };

  return (
    <div className="col">
      <div className="card tech-company-card shadow-sm h-100 border-0" onClick={handleCardClick}>
        <div className={`card-header bg-company-teal py-3 text-white border-0 rounded-top`}>
...
export default TechCompanyCard;