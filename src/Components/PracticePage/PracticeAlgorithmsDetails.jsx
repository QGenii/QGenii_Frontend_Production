...
const practiceData = {
  c: {
    ...
    description: "Sharpen your String algorithm skills with curated problems and chapter-wise practice.",
    progress: 65,
    streak: 3,
    leaderboard: 5,
    chapters: [
...
const PracticeAlgorithmsDetails = () => {
  const { id } = useParams();
...
export default PracticeAlgorithmsDetails;