...
// Dummy problems data (only unattempted)
const allProblems = [
  ...
  return (
    <div style={{ background: "#F8FAFF", minHeight: "100vh", padding: 0 }}>
      ...
      <div style={{ width: "100%", display: "flex", justifyContent: "center", marginTop: 32 }}>
        <PracticeTabsNavbar activeTab="unattempted" onTabChange={(tab) => {
...
export default UnattemptedProblemsPage;