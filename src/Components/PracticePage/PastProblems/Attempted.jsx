...
// Dummy problems data (only attempted)
const allProblems = [
  ...
  return (
    <div style={{ background: "#F8FAFF", minHeight: "100vh", padding: 0 }}>
      ...
      <div style={{ width: "100%", display: "flex", justifyContent: "center", marginTop: 32 }}>
        <PracticeTabsNavbar activeTab="attempted" onTabChange={(tab) => {
      ...
      <div style={{ 
        ...
        <div style={{ flex: 1 }}>
          ...
          {/* Left sidebar and Table Container */}
          <div style={{
            display: "flex",
            gap: 24
          }}>
            ...
            <div style={{ flex: "0 0 140px" }}>
              <ProblemsSidebar activeTab={activeTab} setActiveTab={tab => {
                setActiveTab(tab);
                if (tab === "all") navigate("/past/problems");
                if (tab === "unattempted") navigate("/past/problems/unattempted");
                if (tab === "attempted") navigate("/past/problems/attempted");
...
export default AttemptedProblemsPage;