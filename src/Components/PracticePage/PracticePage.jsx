...
import AlgorithmsSection from './Algorithm/AlgorithmsSection';
import DataStructuresSection from './DataStructureCard/DataStructuresSection';
      ...
      <div className="container-fluid py-5">
        <div className="welcome-section shadow-sm p-5 mb-6">
          <h1 className="display-5 fw-bold mb-4">
            Welcome to{' '}
            <span className="text-gradient-purple">QGenii</span> Practice!
          </h1>
          <p className="lead">
