...
const StarWisePathCard = ({ card }) => {
  const navigate = useNavigate();

  const handleCardClick = () => {
    navigate(`/Star/${card.id}`);
  };

  return (
    <div className="col">
      <div className="card star-wise-card shadow-sm h-100 border-0" onClick={handleCardClick}>
...
export default StarWisePathCard;