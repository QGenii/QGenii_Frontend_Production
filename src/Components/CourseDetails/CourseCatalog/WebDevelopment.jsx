...
// Sample WebDevelopment Course Data
const courses = Array(10).fill({
  title: 'Learn Web Development Programming',
  level: 'Beginner',
  description:
    'Learn Web Development  programming language within a month using our practical course. Understand the basic syntax of Web Development using our online tutorial. Prepare for a future in data science...',
  rating: 4.6,
  reviews: 60898,
  learners: '359.4k',
  totalCourses: 6,
...
// 🔷 Main Page
export default function LearnWebDevelopment() {
  return (
    <div className="w-full px-4 py-8 md:px-16 bg-white font-sans">
      {/* Page Title */}
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Learn Web Development</h1>
        <p className="text-gray-600 max-w-3xl text-[15px] leading-relaxed">
          Web Development is a versatile and user-friendly programming language known for its readability and
      ...
      <div className="mb-10">
        <p className="font-semibold mb-2 text-[15px] text-gray-800">New to Web Development? Start here</p>
      ...
      {/* WebDevelopment Course Cards */}
      <h2 className="text-xl font-semibold text-gray-800 mb-4">Basic of Web Development (10)</h2>
