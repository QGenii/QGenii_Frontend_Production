  ...
  return (
    ...
    />
        ...
        <div className="flex flex-1 justify-between max-w-[900px] mx-auto ml-[640px] text-l">
          <span className="text-black font-bold text-xl hover:text-blue-600 cursor-pointer transition-colors uppercase tracking-wide flex-1 text-center">HOME</span>
          <span className="text-black font-bold text-xl hover:text-blue-600 cursor-pointer transition-colors uppercase tracking-wide flex-1 text-center">BLOG</span>
          <span className="text-black font-bold text-xl hover:text-blue-600 cursor-pointer transition-colors uppercase tracking-wide flex-1 text-center">PARTNERSHIP</span>
          <span className="text-black font-bold text-xl hover:text-blue-600 cursor-pointer transition-colors uppercase tracking-wide flex-1 text-center">CONTACT US</span>
        </div>
      ...
      <div className="bg-[#0288E7] w-full">
        <div className="max-w-[1600px] mx-auto flex items-center h-[56px] px-0">
          ...
          <div className="flex flex-1 justify-between max-w-[900px] mx-auto px-10 text-[#f1f1f1]">
            <span className=" font-semibold text-xl cursor-pointer hover:underline flex-1 text-center">Compiler</span>
            <span className=" font-semibold text-xl cursor-pointer hover:underline flex-1 text-center">IQ Business</span>
            <span className=" font-semibold text-xl cursor-pointer hover:underline flex-1 text-center">Teach on IQ</span>
            <span className=" font-semibold text-xl cursor-pointer hover:underline flex-1 text-center">My Studying</span>
