...
// Sample Java Course Data
const courses = Array(10).fill({
  title: 'Learn Java Programming',
  level: 'Beginner',
  description:
    'Learn Java programming language within a month using our practical course. Understand the basic syntax of Java using our online tutorial. Prepare for a future in data science...',
  rating: 4.6,
  reviews: 60898,
  learners: '359.4k',
  totalCourses: 6,
    ...
    <div className="bg-[#90E0EFB2] rounded-xl p-5 shadow-md hover:shadow-lg transition-all font-sans">
      ...
      <div className="flex items-start gap-3 mb-3">
        <div className={`bg-[#FFE379] w-10 h-10 rounded-md  flex items-center justify-center`}>
          {/* need to be changed */}
          <img src="/java.png" alt="Java" className="w-9 h-9" />
        </div>
        <div>
...
export default function LearnJava() {
  return (
    <div className="w-full px-4 py-8 md:px-16 bg-white font-sans">
      {/* Page Title */}
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Learn Java</h1>
        <p className="text-gray-600 max-w-3xl text-[15px] leading-relaxed">
          Java is a versatile and user-friendly programming language known for its readability and
      ...
      <div className="mb-10">
        <p className="font-semibold mb-2 text-[15px] text-gray-800">New to Java? Start here</p>
      ...
      {/* Java Course Cards */}
      <h2 className="text-xl font-semibold text-gray-800 mb-4">Basic of Java (10)</h2>
