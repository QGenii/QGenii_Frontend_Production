  ...
  return (
    <>
        ...
        <div className="relative">
          <div className=" absolute  bottom-9  left-60 w-200 ">
            <p className="terms ">
          ...
          <section className="form-section bg-[lightgray] bg-[50%] bg-cover bg-no-repeat" style={{backgroundImage:`url(${ContentImage2})`
                ...
                >
                  ...
                  <div className="form-row">
                    ...
                    <div className="form-group">
                      ...
                      <select {...register("jobLevel", { required: true })}>
                  ...
                  <div className="form-group full-width">
                    <label>Write about your organization training need?</label>
                    <textarea
                      placeholder="Enter information here"
                      {...register("trainingNeed")}
                    ></textarea>
                  </div>
