    ...
    const fetchData = async () => {
      try {
        ...
        if (statsResponse.data) {
          ...
          // Update progress bars if stats contain progress data
          if (statsResponse.data.dailyProgress) {
            setDailyProgress(statsResponse.data.dailyProgress);
          }
          if (statsResponse.data.weeklyProgress) {
            setWeeklyProgress(statsResponse.data.weeklyProgress);
          }
        }
        setError(null);
      } catch (err) {
