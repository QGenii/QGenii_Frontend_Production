...
import Logo from '../../../../../assets/assets/WhatWedo/ByIndustry/Technology/Logo.png';
    ...
    >
      <div className="learning-eco-system-content flex items-center justify-evenly gap-[5rem]   ">
       ...
       Innovate faster with employees certified on in-demand skills
          ...
          >
From first hello to high-performance, learning that builds, proves, and amplifies your team’s potential.        </div>
