...
import Logo from '../../../../../assets/assets/WhatWedo/ByIndustry/FinancialService/Logo.png';
import bgimg from '../../../../../assets/assets/WhatWedo/ByIndustry/FinancialService/bgimg.jpg';
import { Link } from 'react-router-dom';
const FinancialServiceSection1 = () => {
    return (
        <div
            style={{
...
Innovate financial services with strategic skill development                    </h2>
                    <div
                        style={{ fontSize: "0.875rem" }}
                        className="text-black font-poppins mb-2 not-italic font-normal leading-normal capitalize w-[40.4rem]"
                    >
                    Build the technical expertise that turns digital challenges into customer-centric solutions.       </div>
...
export default FinancialServiceSection1