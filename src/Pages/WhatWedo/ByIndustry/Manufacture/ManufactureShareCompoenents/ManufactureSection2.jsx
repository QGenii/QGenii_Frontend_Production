...
export default function ManufactureSection2() {
    const cards = [
        {

            number: "5,000+ hours",
            desc: "AWS training completed in 12 months                              ",
            company: "XYZ name"
        },
        {

            number: "$220K saved",
            desc: "by reducing training costs with Qgenii business",
             company: "XYZ name"
        },
                ...
                {cards.map((card, idx) => (
                    ...
                    >
                        ...
                        <div className="flex flex-col justify-center items-center gap-[0.62rem]">   
                            ...
                            <p className=" text-[0.785rem] text-gray-600 text-center w-[22rem]  h-[2rem]">{card.desc}</p></div>
