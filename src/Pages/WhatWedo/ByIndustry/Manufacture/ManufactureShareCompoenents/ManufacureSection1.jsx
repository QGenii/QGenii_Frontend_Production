...
import Logo from '../../../../../assets/assets/WhatWedo/ByIndustry/Manufacture/Logo.png';
import bgimg from '../../../../../assets/assets/WhatWedo/ByIndustry/Manufacture/bgimg.jpg';
import { Link } from 'react-router-dom';
const ManufactureSection1 = () => {
    return (
        <div
            style={{
            ...
            <div className="learning-eco-system-content flex items-center justify-evenly gap-[5rem]   ">
                ...
                <div className="learning-eco-system-left-side max-w-md font-poppins flex flex-col items-start   ">
                    ...
                    <h2 className="text-black font-poppins text-[2.25rem] font-medium capitalize w-[39.75rem] mb-1">
                       ...
                       Power smarter manufacturing with an AI-skilled workforce
                    </h2>
                    <div
                        style={{ fontSize: "0.875rem" }}
                        className="text-black font-poppins mb-2 not-italic font-normal leading-normal capitalize w-[40.4rem]"
                    >
                      Close critical skills gaps across your workforce with scalable, on-demand learning built for today’s evolving manufacturing landscape.       </div>
...
export default ManufactureSection1