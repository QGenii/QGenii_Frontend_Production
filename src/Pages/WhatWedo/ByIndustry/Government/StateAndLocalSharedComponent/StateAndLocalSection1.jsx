...
import Logo from '../../../../../assets/assets/WhatWedo/ByIndustry/Government/StateAndLocal/Logo.png';
import bgimg from '../../../../../assets/assets/WhatWedo/ByIndustry/Government/StateAndLocal/bgimg.jpg';
import { Link } from 'react-router-dom';

const StateAndLocalSection1 = () => {
    return (
        <div
            style={{
        ...
        >
            <div className="learning-eco-system-content flex items-center justify-evenly gap-[5rem]   ">
                ...
                <div className="learning-eco-system-left-side max-w-md font-poppins flex flex-col items-start   ">
                    ...
                    FOR STATE AND LOCAL AGENCIES              </h4>
                    <h2 className="text-black font-poppins text-[2.25rem] font-medium capitalize w-[39.75rem] mb-1">

                    Equip your team with the skills that matter  
                    </h2>
                    <div
                        style={{ fontSize: "0.875rem" }}
                        className="text-black font-poppins mb-2 not-italic font-normal leading-normal capitalize w-[40.4rem]"
                    >
                   Constantly updated online courses give your team the training they need to keep pace with change and tackle tomorrow’s agency workforce challenges.      </div>
...
export default StateAndLocalSection1