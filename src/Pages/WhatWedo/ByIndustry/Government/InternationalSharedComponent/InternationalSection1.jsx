...
import Logo from '../../../../../assets/assets/WhatWedo/ByIndustry/Government/International/Logo.png';
import bgimg from '../../../../../assets/assets/WhatWedo/ByIndustry/Government/International/bgimg.jpg';
        ...
        >
            <div className="learning-eco-system-content flex items-center justify-evenly gap-[5rem]   ">
                ...
                <div className="learning-eco-system-left-side max-w-md font-poppins flex flex-col items-start   ">
                    ...
                    FOR INTERNATIONAL GOVERNMENT            </h4>
                    ...
                    >
                Ensure that all your public servants have the crucial skills they need to stay ahead of global transformation.    </div>
