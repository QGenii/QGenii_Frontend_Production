...
import Vector from "../../../../../assets/assets/SmallTrainingTeam/Vector.svg";
...
const CoursesSection = () => {
  ...
  return (
    <div className="py-2 bg-gray-50 text-center">
      <div className="flex flex-col justify-center items-center w-[69.375rem] gap-[2.5rem] mx-auto">

        <h4 className=" text-center text-[1.5rem] font-medium font-[poppins] leading-[normal] mt-[3rem]">
          A marketplace built for improving business results
        </h4>
        {/* Course Cards */}
            ...
            >
              ...
              <div className="flex flex-col items-start justify-start gap-[0.55363rem]">
                ...
                <div className="bg-[#ECEEF6] text-start flex items-center justify-center">
                  ...
                  <p className="text-[0.488rem] text-gray-600  ">{course.instructor}</p>
                </div>
