...
import Logo from '../../../../../assets/assets/WhatWedo/RemoteAndHybrid/Logo.png';
import bgimg from '../../../../../assets/assets/WhatWedo/RemoteAndHybrid/bgimg.jpg';
const Section1 = () => {
  return (
    <div
      style={{
      ...
      className="learning-eco-system-container w-full h-[441px] grid items-center  bg-cover bg-center mb-10 bg-[lightgray]"
    >
      <div className="learning-eco-system-content flex items-center justify-evenly gap-[5rem]   ">
        ...
        <div className="learning-eco-system-left-side max-w-md font-poppins flex flex-col items-start   ">
          ...
          <h2 className="text-black font-poppins text-[2.25rem] font-medium capitalize w-[39.75rem] mb-1">
            ...
            Engage and advance employees from wherever they are
          </h2>
          <div
            style={{ fontSize: "0.875rem" }}
            className="text-black font-poppins mb-2 not-italic font-normal leading-normal capitalize w-[36.4rem]"
          >
            We’ve got integrated learning solutions to skill up your whole organization from home or the office.
          </div>
        ...
        {/* Right Side */}
        <div className="learning-eco-system-right-side w-[35.125rem] h-[23.4rem]  aspect-[195/188] flex-shrink-0 ml-6 overflow-hidden ">
          <img
            src={Logo}
