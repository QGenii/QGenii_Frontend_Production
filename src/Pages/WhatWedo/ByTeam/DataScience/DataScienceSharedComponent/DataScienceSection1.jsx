...
import Logo from '../../../../../assets/assets/WhatWedo/ByTeam/DataScience/Logo.png';
import bgimg from '../../../../../assets/assets/WhatWedo/ByTeam/ITOperation/bgimg.jpg';
const DataScienceSection1 = () => {
  return (
    <div
      style={{
...
information into insight
          ...
          >
Collect, manage, secure, and analyze data better, with upskilling.         </div>
...
export default DataScienceSection1