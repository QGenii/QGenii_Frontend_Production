...
import Logo from '../../../../../assets/assets/WhatWedo/ByTeam/LearningAndDevelopment/Logo.png';
import bgimg from '../../../../../assets/assets/WhatWedo/ByTeam/LearningAndDevelopment/bgimg.jpg';
const Section1 = () => {
  return (
    <div
      style={{
    ...
    >
      <div className="learning-eco-system-content flex items-center justify-evenly gap-[5rem]   ">
        ...
        Grow your people, grow your business
          ...
          >
Move toward employee and business goals with on-demand courses for everyone, hands-on-training for tech teams, and cohort leadership development.
          </div>
