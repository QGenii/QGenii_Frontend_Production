...
const Section3 = () => {
  const features = [
    ...
    {
      title: "Accommodate different learning styles",
      description:
        "Offer on-demand, immersive, and cohort learning, with a library of proven configurations by learning type and topic.",
    ...
    {
      title: "Upskill your global teams",
      description:
        "Teams of any size can access learning programs that helps them learn the skills they need in their preferred languages.",
  ...
  return (
    ...
    <h4 className=" text-[1.875rem] font-semibold font-poppins leading-[normal]">Develop the skills your employees need to drive critical outcomes</h4>
