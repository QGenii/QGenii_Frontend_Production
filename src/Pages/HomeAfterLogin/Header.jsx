      ...
      <div className="bg-[#0288E7] w-full">
        <div className="max-w-[1600px] mx-auto flex items-center h-[56px] px-0">
          ...
          <div className="flex flex-1 justify-between max-w-[900px] mx-auto px-10 text-[#f1f1f1]">
            ...
            <span className=" font-semibold text-xl cursor-pointer hover:underline flex-1 text-center" onClick={() => (window.location.href = 'https://codeiqgenius-frontend-g17v.vercel.app/')}>IQ Business</span>
            ...
            <span className=" font-semibold text-xl cursor-pointer hover:underline flex-1 text-center" onClick={() => (window.location.href = 'https://codeiqgenius-frontend-g17v.vercel.app/mystudying')}>My Studying</span>
      ...
      <div className="bg-slate-800 text-white text-sm font-normal space-x-20">
        <div className="max-w-[90%] mx-auto py-3 overflow-x-auto">
          <div className="flex justify-center gap-28 text-center text-base whitespace-nowrap">
            ...
            <span className="cursor-pointer hover:text-blue-300" onClick={() => (window.location.href = 'https://codeiqgenius-frontend-nitesh.vercel.app/study-plan')}>Study Plan</span>
            <span className="cursor-pointer hover:text-blue-300" onClick={() => (window.location.href = 'https://codeiqgenius-frontend-nitesh.vercel.app/practice')}>Practice</span>
            <span className="cursor-pointer hover:text-blue-300" onClick={() => (window.location.href = 'https://codeiqgenius-frontend-nitesh.vercel.app/contest')}>Contest</span>
            <span className="cursor-pointer hover:text-blue-300" onClick={() => (window.location.href = 'https://codeiqgenius-frontend-nitesh.vercel.app/jobs')}>Job Portal</span>
            <span className="cursor-pointer hover:text-blue-300" onClick={() => (window.location.href = 'https://codeiqgenius-frontend-nitesh.vercel.app/community')}>Community</span>
