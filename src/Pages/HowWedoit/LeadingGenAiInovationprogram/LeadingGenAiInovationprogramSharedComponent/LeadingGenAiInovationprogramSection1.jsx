...
const LeadingGenAiInovationprogramSection1 = () => {
    return (
        <div
            style={{
...
export default LeadingGenAiInovationprogramSection1