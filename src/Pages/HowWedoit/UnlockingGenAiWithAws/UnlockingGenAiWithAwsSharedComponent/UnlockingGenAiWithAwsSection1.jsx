...
import Logo from '../../../../assets/assets/HowDoWeIt/UnlockingGenAiWithAws/Logo.png';
import bgimg from '../../../../assets/assets/HowDoWeIt/UnlockingGenAiWithAws/bgImg.jpg';
import { Link } from 'react-router-dom';
const UnlockingGenAiWithAwsSection1 = () => {
    return (
        <div
            style={{
            ...
            <div className="learning-eco-system-content flex items-center justify-evenly gap-[5rem]   ">
                ...
                <div className="learning-eco-system-left-side max-w-md font-poppins flex flex-col items-start   ">
                    <h4 className="text-[#2800AE] font-poppins text-[1rem] font-semibold uppercase mb-1">
                        Unlocking GenAI Opportunities with AWS             </h4>
                    <h2 className="text-black font-poppins text-[2.25rem] font-medium capitalize w-[39.75rem] mb-1">

                       Unlocking GenAI Opportunities with AWS      </h2>
                    <div
                        style={{ fontSize: "0.875rem" }}
                        className="text-black font-poppins mb-2 not-italic font-normal leading-normal capitalize w-[40.4rem]"
                    >
                        Prepare Leaders to Accelerate Growth with GenAI
                        <br />
                        Discover how cohort learning can help your team    </div>
                    <div className="flex w-[30rem]  gap-3 ">
                        <button className="px-[2.5rem] py-3 bg-[#0c316e] text-white font-poppins font-semibold text-base rounded-md shadow-md transition flex">
                            <Link to='/requestdemo' className='flex gap-1 items-center justify-center'> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
export default UnlockingGenAiWithAwsSection1