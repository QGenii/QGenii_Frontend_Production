...
const features = [
  {
    ...
    description:
      "Develop knowledge about how GenAI works, how to use it, and how to maximize the benefits of AWS GenAI Tools",
  },
  {
    id:2,
      icon: <img  src={Img1} alt="" />,
  ...
  },
  {
    ...
    description:
      "Create messaging and communications to inspire confidence around GenAI in their organization",
  },
  
 
];

export default function UnlockingGenAiWithAwsSection5() {
