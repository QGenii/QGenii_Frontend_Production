 ...
 */
export default function  UpdateEmail({ onSend }) {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto p-8">
      <h4 className="text-center text-[0.875rem] font-medium mb-6">To update ypur email address,please enter your password</h4>
      ...
      <form onSubmit={handleSend} className="space-y-6">
        ...
        <div className="flex justify-center">
          ...
          >
            {status === "sending" ? "Updating..." : "Confirm"}
          </button>
        </div>
